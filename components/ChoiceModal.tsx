      ...
      {addFast.modelOpen && (
        <div className="fixed top-0 left-0 w-full h-full flex items-center justify-center bg-opacity-50">
          <motion.div
            ...
            className="border shadow-sm rounded-md bg-white max-w-fit px-20 py-12"
            style={{ position: "relative" }}
          >
            <div
              onClick={handleModal}
              className="absolute bg-gray-200 top-4 right-4 w-8 h-8 rounded-full flex items-center justify-center cursor-pointer"
            >
